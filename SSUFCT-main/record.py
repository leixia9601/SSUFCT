...
def record_output(oa_ae, aa_ae, kappa_ae, element_acc_ae, training_time_ae, testing_time_ae, confusion_matrix, classification, average_OA, average_AA, average_KAPPA, wholepic_pre_time, average_GPU_memory_used, path):
    f = open(path, 'a')
    ...
    f.write(sentence10)
    sentence11 = "Classification: " + '\n' + str(classification) + '\n'
    f.write(sentence11)
    sentence12 = "Average OA is: " + str(average_OA) + '\n' + "Average AA is: " + str(average_AA) + '\n' + "Average Kappa is: " + str(average_KAPPA) + '\n'
    f.write(sentence12)
    sentence13 = 'Total average Prediction time for whole pic is: ' + str(wholepic_pre_time) + '\n'+ '\n'
    f.write(sentence13)
    sentence14 = 'Total average GPU memory used is: ' + str(average_GPU_memory_used) + '\n' + '\n'
    f.write(sentence14)
    f.close()

...
class CET(nn.Module):
    def __init__(self, num_classes):
        ...
        self.dsc_conv2d_features = nn.Sequential(
            Separable2D(input_filters=8 * (10-2), output_filters=64),
            nn.BatchNorm2d(64),
            nn.ReLU(),
        )
...
# num_classes = 15
# model = CET(num_classes)
# summary(model, input_size=(1, 9, 9, 10), batch_size=-1, device='cpu')
#
# input_tensor = torch.randn(64, 1, 9, 9, 10)
